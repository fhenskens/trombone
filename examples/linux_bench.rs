...
fn print_help() {
    println!("Linux audio benchmark options:");
...
fn run_output(options: BenchOptions, backend: LinuxBackend) -> Result<BenchResult, String> {
...
fn run_input(options: BenchOptions, backend: LinuxBackend) -> Result<BenchResult, String> {
...
fn run_duplex(options: BenchOptions, backend: LinuxBackend) -> Result<BenchResult, String> {
